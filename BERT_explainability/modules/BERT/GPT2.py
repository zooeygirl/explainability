...
class GPT2Attention(nn.Module):
    ...
    def transpose_for_scores(self, x):
        ...
        new_x_shape = x.size()[:-1] + (self.num_heads, self.num_heads)
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None):
        ...
        attn_weights = self.softmax(dim=-1)(attn_weights)
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        #explain
        ao1, ao2 = self.clone(attn_output, 2)
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.ln_f = LayerNorm(config.embed_dim, eps=config.layer_norm_epsilon)
    ...
    def relprop(self, cam, **kwargs):
         ...
         cam = self.ln_f.relprop(cam, **kwargs)
         for layer_module in reversed(self.h):
